...
class user(models.Model):
    ...
    user_type = models.IntegerField(default=None)
...
class ad_listing(models.Model):
    ...
    ad_status = models.IntegerField(default=None)
    ad_duration = models.IntegerField
    is_ad_promoted = models.BooleanField(default=False)
    promotion_duration = models.IntegerField(default=None)
...
class feedback(models.Model):
    ...
    comments = models.TextField(max_length=250,default=None)
